...
int main()
{
	...
	case 'A':  view_all(p);
	    break;
	case 'D':
	    cout << char(current_index + 'A') << ".antiderivative: ";
	    view(p[current_index].antiderivative( ));
	    break;
    case 'I':
        double x0, x1;
        cout << "Lower bound: ";
        ...
        cout << "Upper bound: ";
        cin >> x1;
        cout << "The lower bound is " << x0 << "\nThe upper bound is " << x1 << "\n";
	    cout << p[current_index].definite_integral(x0,x1) << "\n";
	    break;
    case 'Z':
	    cout << p[current_index].is_zero() << "\n";
	    break;
...
void print_menu()
{
    ...
    cout << "D - view antiderivative of current polynomial" << endl;
    cout << "I - view definite integral of current polynomial" << endl;
    cout << "E - evaluate current polynomial by using () op" << endl;
    cout << "Z - evaluate is_zero()" << endl;
